var view = {
  ...
  showPersonal: function(){
    ...
    if(model.personalInfo.profileSetUp === 0){
      document.getElementsByTagName('body')[0].innerHTML = "<div class='col-xs-12 text-center' style='height:100%;background-color:white'><div class='row'><div class='col-xs-12' style='margin-top:150px'><div class='row'><div class='col-xs-10 col-xs-offset-1' style='color:grey;border-radius:3px;font-size:18px;padding:10px;margin-bottom:10px;'>We need to know little more about you. Please provide us some more information</div></div><div class='row'><div class='col-xs-8 col-xs-offset-2'><div class='btn btn-primary' onclick='view.setUpProfile()'>Set up Profile</div></div></div></div></div></div>"
    } else {
      console.log(model);
